...
export const THEME_ICONS: Record<keyof typeof THEME_SETS, string> = {
  blue: '/static/images/logo-blue.webp',
  purple: '/static/images/logo-purple.webp',
  coffee: '/static/images/logo-coffee.webp',
  green: '/static/images/logo-green.webp',

  olympus: '/static/images/logo-olympus.webp',

  end: '/static/images/logo-end.webp',
  ocean: '/static/images/logo-ocean.webp',
  desert: '/static/images/logo-desert.webp',
  soulSandValley: '/static/images/logo-soul-sand-valley.webp',
  crimsonForest: '/static/images/logo-ivory.webp',
  warpedForest: '/static/images/logo-warped-forest.webp',
  basaltDeltas: '/static/images/logo-basalt-deltas.webp',
  paleGarden: '/static/images/logo-pale-garden.webp',
  deepDark: '/static/images/logo-deep-dark.webp',

  galaxy: '/static/images/logo-galaxy.webp',
  nebula: '/static/images/logo-nebula.webp',
  supernova: '/static/images/logo-supernova.webp',
  starlight: '/static/images/logo-starlight.webp',
  blackHole: '/static/images/logo-black-hole.webp',
  aurora: '/static/images/logo-aurora.webp',
  eclipse: '/static/images/logo-gryffindor.webp',
  quasar: '/static/images/logo-aphrodite.webp',
  void: '/static/images/logo-monochrome.webp',

  zeus: '/static/images/logo-zeus.webp',
  hera: '/static/images/logo-hera.webp',
  poseidon: '/static/images/logo-poseidon.webp',
  demeter: '/static/images/logo-demeter.webp',
  athena: '/static/images/logo-athena.webp',
  apollo: '/static/images/logo-apollo.webp',
  artemis: '/static/images/logo-artemis.webp',
  ares: '/static/images/logo-ares.webp',
  aphrodite: '/static/images/logo-aphrodite.webp',
  hephaestus: '/static/images/logo-hephaestus.webp',
  hermes: '/static/images/logo-hermes.webp',
  dionysus: '/static/images/logo-dionysus.webp',
  hestia: '/static/images/logo-hestia.webp',
  hades: '/static/images/logo-hades.webp',

  sunset: '/static/images/logo-sunset.webp',
  azure: '/static/images/logo-azure.webp',
  twilight: '/static/images/logo-twilight.webp',
  ivory: '/static/images/logo-crimson-forest.webp',

  monochrome: '/static/images/logo-monochrome.webp',

  gryffindor: '/static/images/logo-fire.webp',
  slytherin: '/static/images/logo-slytherin.webp',
  ravenclaw: '/static/images/logo-hermes.webp',
  hufflepuff: '/static/images/logo-hufflepuff.webp',

  fire: '/static/images/logo-fire.webp',
  water: '/static/images/logo-water.webp',
  earth: '/static/images/logo-earth.webp',
  air: '/static/images/logo-air.webp',

  custom: '/static/images/favicon.webp'
};
